...
const dateType = computed(() => (props.schema?.dateType as string) || 'date')
const format = computed(() => props.schema?.format as string | undefined)
const valueFormat = computed(() => props.schema?.valueFormat as string | undefined)
</script>
